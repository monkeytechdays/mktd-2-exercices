 ...
 *
 * -----------------------------------------------------
 * Le but de cet HOC est de rendre accessible un service dans les composants fils
 * Il faut donc le positionner le plus haut possible de sorte que tous ceux qui
 * ont besoin de ce service y aient accès. (en terme plus algorithmique, il faut
 * que le noeud ou est placé le container soit l'origine des branches qui
