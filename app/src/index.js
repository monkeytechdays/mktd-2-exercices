...
//
// Pour avoir quelque chose de stable, il faut passer par ceci.
// Les routes peuvent aussi être déclarées sous forme d'objet (très pratique quand on
// veut passer par de la génération)
//
// ```
